...
export const SETTINGS_CONFIG_FIELDS: readonly ConfigFieldContract[] = [
  ...
  envField('video_gen_endpoint_profile', 'agent', 'text', 'VIDEO_GEN_ENDPOINT_PROFILE'),
  envField('video_gen_vendor_key', 'agent', 'text', 'VIDEO_GEN_VENDOR_KEY'),
  envField('video_gen_plan', 'agent', 'text', 'VIDEO_GEN_PLAN'),
