...
class ExtensionLoader:
    ...
    def _import_module(root: Path) -> Any:
        ...
        full_name = f"jiuwenswarm.loaded_extension.{module_name}"

        # 合成包名下的相对导入（如 extension.py 中 from .foo import ...）需要父包
        # jiuwenswarm.loaded_extension 存在于 sys.modules，且本模块需带 __path__ 才能解析同目录子模块。
        parent = "jiuwenswarm.loaded_extension"
