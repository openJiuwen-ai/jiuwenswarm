...
in tools[], navigation, or the search corpus. glob / read_file register
the flash-enhanced variants (mtime-sorted gitignore glob, parallel
multi-file read). Being a SysOperationRail subclass, subagent rail
inheritance still detects it and reuses this slim rail instead of adding
a stock one.
