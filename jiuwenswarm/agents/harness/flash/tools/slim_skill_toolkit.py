...
Returned by ``JiuwenSwarmFlashAdapter._build_skill_toolkit`` so flash sessions
discover skills via search_skill (auto-install) and consume them via skill_tool.
"""
