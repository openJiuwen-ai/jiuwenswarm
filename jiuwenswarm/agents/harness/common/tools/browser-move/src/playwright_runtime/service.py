...
from jiuwenswarm.agents.harness.common.tools.browser_timeout_policy import (
...
class BrowserService:
    ...
    def __init__(
        ...
        self._profile_name = (os.getenv("BROWSER_PROFILE_NAME") or "jiuwenswarm").strip() or "jiuwenswarm"
