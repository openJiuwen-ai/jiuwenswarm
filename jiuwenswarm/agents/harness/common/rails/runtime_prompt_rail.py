        ...
        if self._channel in ("tui", "web", "desktop", "ws_client", "__cron__", "cron"):
            ...
            if is_cn:
                directory_content = (
                    ...
                    "- 智能体身份、技能、待办和运行状态只能保存在对应的内部数据目录。\n"
                ...
                directory_content = (
                    ...
                    "小艺 work keeps its startup configuration, Agent identity, skills, "
                    ...
                    f"| `{agent_workspace_dir}` | Agent internal data directory | stores identity, skills, todos, runtime state | do not search or run user project files inside it |\n"
                    ...
                    "project directory.\n"
                    "- Agent identity, skills, to-dos, and runtime state must be stored only in their "
