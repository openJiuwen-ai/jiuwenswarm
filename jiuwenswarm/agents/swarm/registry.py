...
TEAM_DELIVERABLE_LOCATION = _member_rails.TEAM_DELIVERABLE_LOCATION
CONTEXT_PROCESSOR = _member_rails.CONTEXT_PROCESSOR
EXTERNAL_MEMORY = _member_rails.EXTERNAL_MEMORY
...
TEAM_MEMBER_IDENTITY = _member_rails.TEAM_MEMBER_IDENTITY
EXPERT_TEAM_DELEGATION_GATE = _member_rails.EXPERT_TEAM_DELEGATION_GATE
