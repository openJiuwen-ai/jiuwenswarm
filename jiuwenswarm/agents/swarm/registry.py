...
OPTIMIZER_TOOLKIT = _tools.OPTIMIZER_TOOLKIT
...
PROMPT_OPTIMIZER_PROMPT = _member_rails.PROMPT_OPTIMIZER_PROMPT
PROMPT_OPTIMIZER_REVIEW = _member_rails.PROMPT_OPTIMIZER_REVIEW
