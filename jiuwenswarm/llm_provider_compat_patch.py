...
def _flatten_text_blocks(value: Any) -> Any:
    """Use the scalar text shape accepted by ModelArts' Anthropic facade."""
...
def _patch_openai_modelarts_tool_choice(client_class: type) -> None:
    ...
    def _build_request_params(self, *args, **kwargs):
        ...
        if (
            ...
            # This hosted model rejects automatic tool selection unless its
            # serving deployment enables a tool-call parser.
