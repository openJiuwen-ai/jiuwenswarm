...
ROUTES: list[RouteSpec] = [
    ...
    RouteSpec("POST", "/mcp/servers", ReqMethod.MCP_SERVER_ADD.value),
    RouteSpec("POST", "/mcp/servers/remove", ReqMethod.MCP_SERVER_REMOVE.value),
    RouteSpec("POST", "/mcp/servers/update", ReqMethod.MCP_SERVER_UPDATE.value),
    RouteSpec("GET", "/mcp/servers", ReqMethod.MCP_SERVER_LIST.value),
    RouteSpec("GET", "/mcp/servers/{name}", ReqMethod.MCP_SERVER_GET.value),
    ...
    # --- 数字分身 / 用户态 IM 托管 ---
    RouteSpec("GET", "/im/hosting/status", ReqMethod.IM_HOSTING_STATUS.value),
    RouteSpec("GET", "/im/hosting/discover", ReqMethod.IM_HOSTING_DISCOVER.value),
    RouteSpec("GET", "/im/hosting/targets", ReqMethod.IM_HOSTING_TARGETS_LIST.value),
    RouteSpec("POST", "/im/hosting/targets", ReqMethod.IM_HOSTING_TARGETS_ADD.value, 201),
    RouteSpec("PATCH", "/im/hosting/targets/{id}", ReqMethod.IM_HOSTING_TARGETS_PATCH.value),
    RouteSpec("DELETE", "/im/hosting/targets/{id}", ReqMethod.IM_HOSTING_TARGETS_DELETE.value),
    RouteSpec("GET", "/im/hosting/policy", ReqMethod.IM_HOSTING_POLICY_GET.value),
