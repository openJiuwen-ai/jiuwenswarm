...
相关文档：[Gateway Web HTTP 通用说明](Gateway%20Http接口文档.md)、[Manager→Gateway Config Receiver 通用说明](../../jiuwenswarm/gateway/docs/Gateway%20Config%20Receiver%20接口文档.md)、[A2A 接入说明](A2A.md)。
