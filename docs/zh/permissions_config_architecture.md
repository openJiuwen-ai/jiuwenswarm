...
> Manager ↔ Gateway 模板接口：[Gateway Config Receiver 接口文档.md](../../jiuwenswarm/gateway/docs/Gateway%20Config%20Receiver%20接口文档.md) §8
...
接口细节见 [Gateway Config Receiver 接口文档.md](../../jiuwenswarm/gateway/docs/Gateway%20Config%20Receiver%20接口文档.md) §8。  
