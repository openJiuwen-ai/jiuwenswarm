...
- **Field**: `kv_cache_affinity_config.enable_kv_cache_affinity` (Application scope)
- **Client**: AgentOS uses `client_provider: AscendAffinity`; OpenAI extensions alone do not enable KVC on this branch.
