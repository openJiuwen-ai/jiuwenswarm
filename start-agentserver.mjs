#!/usr/bin/env node
/**
 * jiuwenswarm-agentserver 启动脚本 (Node.js 版本)
...
const isOhos = process.env.JIUWENSWARM_RUNTIME_PLATFORM === 'ohos'
  || process.env.JIUWENCLAW_RUNTIME_PLATFORM === 'ohos'
