...
FILE_LIST_DIRECTORY = FILE_READ_DATA  # 同值; 列目录
FILE_READ_ATTRIBUTES = 0x00000080
FILE_ALL_ACCESS = 0x001F01FF  # icacls (F); 修主目录 DACL 时保证宿主用户不丢权限
...
# SECURITY_DESCRIPTOR_CONTROL (winnt.h). SetFileSecurity 靠 SD 控制位保留
# 「禁止继承」; 新建空 SD 会清掉此位, C:\\Users 的 Users 组 ACE 灌进主目录.
SE_DACL_PROTECTED = 0x1000

# 不应出现在用户主目录显式 DACL 上的「全世界可读」SID.
