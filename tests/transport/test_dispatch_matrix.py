...
_DISPATCH_TABLE_METHODS = frozenset({
    ...
    "AGENT_RELOAD_CONFIG", "BROWSER_RUNTIME_RESTART", "CHAT_CANCEL",
    "CHAT_STEER", "CHAT_STEER_STATUS", "COMMAND_ADD_DIR",
    "COMMAND_BTW", "COMMAND_CHROME", "COMMAND_COMPACT", "COMMAND_COMPACT_PARTIAL",
    "COMMAND_CONTEXT", "COMMAND_DIFF", "COMMAND_MCP", "MCP_SERVER_ADD",
    "MCP_SERVER_GET", "MCP_SERVER_LIST", "MCP_SERVER_REMOVE", "MCP_SERVER_UPDATE",
    "COMMAND_MODEL", "COMMAND_RECAP",
    ...
    "HISTORY_GET", "HOOKS_LIST",
    "IM_HOSTING_DISCOVER", "IM_HOSTING_POLICY_GET", "IM_HOSTING_POLICY_PATCH",
    "IM_HOSTING_HISTORY", "IM_HOSTING_POLL_NOW", "IM_HOSTING_STATUS",
    "IM_HOSTING_TARGETS_ADD", "IM_HOSTING_TARGETS_DELETE",
    "IM_HOSTING_TARGETS_LIST", "IM_HOSTING_TARGETS_PATCH",
    "ISSUE_DELETE", "ISSUE_MATRIX", "ISSUE_STATE_LIST",
    "ISSUE_WATCH_ONCE", "LONG_HORIZON", "PROACTIVE_TICK", "SCHEDULE_CANCEL", "SCHEDULE_CHECK_CONFIG",
